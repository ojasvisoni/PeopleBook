...
Route::get('producer-home', 'Company\CompanyController@index')->name('company.home');
Route::get('companies', 'Company\CompaniesController@company_listing')->name('company.listing');
Route::get('producer-profile', 'Company\CompanyController@companyProfile')->name('company.profile');
Route::put('update-company-profile', 'Company\CompanyController@updateCompanyProfile')->name('update.company.profile');
Route::get('posted-opportunity', 'Company\CompanyController@postedJobs')->name('posted.jobs');
Route::get('producer/{slug}', 'Company\CompanyController@companyDetail')->name('company.detail');
...
Route::get('followers', 'Company\CompanyController@companyFollowers')->name('company.followers');
...
Route::get('producer-messages', 'CompanyMessagesController@all_messages')->name('company.messages');
