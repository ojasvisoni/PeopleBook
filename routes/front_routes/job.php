...
Route::get('opportunity/{slug}', 'Job\JobController@jobDetail')->name('job.detail');
...
Route::get('opportunities', 'Job\JobController@jobsBySearch')->name('job.list');
...
Route::get('my-mentor-applications', 'Job\JobController@myJobApplications')->name('my.job.applications');
Route::get('list-rejected-users/{id}', 'Company\CompanyController@listRejectedUsers')->name('rejected-users');
Route::get('my-favourite-mentoring', 'Job\JobController@myFavouriteJobs')->name('my.favourite.jobs');
Route::get('post-opportunity', 'Job\JobPublishController@createFrontJob')->name('post.job');
...
Route::get('consumers', 'Job\JobSeekerController@jobSeekersBySearch')->name('job.seeker.list');
