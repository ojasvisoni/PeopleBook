...
@include('includes.inner_page_title', ['page_title'=>__('Apply for Mentoring Opportunity')]) 
<!-- Inner Page Title end -->
<div class="listpgWraper">
    <div class="container"> @include('flash::message')
        <div class="row">
            <div class="col-md-12">
                <div class="userccount apply-job-form">
...
<!--                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="formrow"> 
                                    <textarea class="form-control" placeholder="Problem Area Description"  name="" type="text" value=""></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="formrow"> 
                                    <textarea class="form-control" placeholder="My Expectation"  name="" type="text" value=""></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
                        <input type="submit" class="btn" value="{{__('Apply for Mentoring')}}">
                        {!! Form::close() !!} </div>
                </div>
            </div>
        </div>
