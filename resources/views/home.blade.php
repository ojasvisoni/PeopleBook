                            ...
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-7">
                                        ...
                                        <h6><span>Location : </span> {{Auth::user()->getLocation()}}</h6>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="editbtbn"><a href="{{ route('my.profile') }}"><i class="fas fa-pencil-alt" aria-hidden="true"></i> Edit Profile</a>
                                        </div>
                                    </div>
                                </div>
                                <ul class="userdata">
                                    <li class="user-data-phone"><span>Phone No. : </span> {{auth()->user()->phone}}</li>							
                                    <li class="user-data-phone"><span>Email Id : </span> {{auth()->user()->email}}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="profbox">
                            ...
                            <h3><i class="fa fa-black-tie" aria-hidden="true"></i>Recommended Mentoring Opportunities</h3>
