...
@include('includes.inner_page_title', ['page_title'=>__('Producer Profile')])
...
<!--                            <li class="row">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6">{{__('Current Opportunity')}}</div>
