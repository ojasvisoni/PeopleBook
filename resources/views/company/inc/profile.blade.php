...
<h5>{{__('Acount Info')}}</h5>
<div class="row">
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'email') !!
            }">
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'password') !!
            }">
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'name') !!
            }">
            <label>{{__('Name')}}</label>
...
<!--    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'ceo') !!
            }">
...
<!--    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'industry_id') !!
            }">
...
<!--    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'ownership_type') !!
            }">
    ...
    <div class="col-md-12">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'description') !!
            }">
    ...
    <div class="col-md-12">
        <div class="formrow {
            ...
            <label>{{__('My Purpose')}}</label>
            {!! Form::textarea('my_purpose', null, array('class'=>'form-control', 'id'=>'my_purpose', 'placeholder'=>__('My Purpose'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'description') !!} </div>
    </div>
    <div class="col-md-12">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'location') !!
            }">
...
<!--    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'no_of_offices') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'no_of_employees') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'established_in') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'website') !!
            }">
...
<!--    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'fax') !!
            }">
            <label>{{__('Fax')}}</label>
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'phone') !!
            }">
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'facebook') !!
            }">
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'twitter') !!
            }">
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'linkedin') !!
            }">
...
<!--    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'google_plus') !!
            }">
    ...
    <div class="col-md-6">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'pinterest') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'country_id') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'state_id') !!
            }">
    ...
    <div class="col-md-4">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'city_id') !!
            }">
            <label>{{__('City')}}</label>
...
<!--    <div class="col-md-12">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'map') !!
            }">
    ...
    <div class="col-md-12">
        <div class="formrow {
                !! APFrmErrHelp::hasError($errors, 'is_subscribed') !!
            }">
            <?php
