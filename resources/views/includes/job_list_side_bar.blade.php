<div class="col-md-3 col-sm-6"> 
	...
	<a class="btn btn-job-alert" href="javascript:;">
		<i class="fa fa-bell" style="font-size:1.125rem;"></i> {{__('Save Opportunities Alert')}} </a>
	@else
	...
	<a href="{{ route('post.job') }}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Post Opportunities')}}</a>
	@else
    ...
    <div class="sidebar">
        ...
        <!-- Jobs By Title -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Title')}}</h4>
        ...
        <!-- Jobs By Country -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Country')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By State -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By State')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By City -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By City')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Experience -->
<!--        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Experience')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Job Type -->
<!--        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Opportunitie Type')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Job Shift -->
<!--        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Opportunitie Shift')}}</h4>
            <ul class="optionlist view_more_ul">
...
<!--        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Career Level')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Degree Level')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Gender -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Gender')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Industry -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Support Sector')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Skill -->
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Skill')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Opportunities By Functional Areas')}}</h4>
            <ul class="optionlist view_more_ul">
