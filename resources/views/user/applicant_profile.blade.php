        ...
        <div class="usercoverimg">
            ...
            <div class="userMaininfo">
                ...
                <div class="contentbox">
                    <h4 class="seeking-title" style="padding-top: 29px;color: #0c4597;">Graduate in Science Seeking Career Advice</h4>
                    </div>
            </div>
        </div>
        <!-- Buttons -->
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="job-header">
                    ...
                    <div class="contentbox"> 
                        <h3 style="padding-top:20px;">{{__('About me')}}</h3>
            ...
            <div class="col-md-4">
                ...
                <div class="job-header">
                    <div class="jobdetail">
                        ...
                        <table class="jbdetail">
                            <tr>
                                <td>{{__('Is Email Verified')}}</td>
                                <td><span>{{((bool)$user->verified)? 'Yes':'No'}}</span></td>
                            </tr>
                            <tr>
                                <td>{{__('Immediate Available')}}</td>
                                <td><span>{{((bool)$user->is_immediate_available)? 'Yes':'No'}}</span></td>
                            </tr>
                            <tr>
                                <td>{{__('Age')}}</div>
