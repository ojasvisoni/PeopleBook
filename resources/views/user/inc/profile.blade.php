...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'password') !!}">
            <label for="">Change {{__('Password')}}</label>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow"> 
            ...
            {{ ImgUploader::print_image("user_images/$user->cover_image", 120, 140) }} 
        </div>
    </div>
...
<!--    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
            <label for="">National Id/Adhar No.</label>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'seeking_mentorship') !!}">
            <label for="">Title for Seeking Mentorship</label>
            {!! Form::text('seeking_mentorship', null, array('class'=>'form-control', 'id'=>'seeking_mentorship', 'placeholder'=>__('Title for Seeking Mentorship'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'seeking_mentorship') !!} 
        </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
            <label for="">Support Sector</label>
            {!! Form::select('industry_id', [''=>__('Select Sector')]+$industries, null, array('class'=>'form-control', 'id'=>'industry_id')) !!}
