...
@include('includes.inner_page_title', ['page_title'=>'Consumers']) 
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <a href="{{ route('post.job') }}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i>Mentor Opportunity</a>
                    @else
                    ...
                    <div class="searchform">
                        <div class="row">
                            <div class="col-md-{{((bool)$siteSetting->country_specific_site)? 5:3}}">
                                <input type="text" name="search" value="{{Request::get('search', '')}}" class="form-control" placeholder="{{__('Enter Consumer details')}}" />
                            </div>
