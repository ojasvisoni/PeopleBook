                ...
                <div class="userccount">
                    ...
                    <div class="userbtns">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link {{($c_or_e == 'candidate')? 'active':''}}" data-toggle="tab" href="#candidate" aria-expanded="true">Consumer</a></li>

                            <li class="nav-item"><a class="nav-link {{($c_or_e == 'employer')? 'active':''}}" data-toggle="tab" href="#employer" aria-expanded="false">Producer</a></li>
...
<!--                                <div class="formrow{{ $errors->has('middle_name') ? ' has-error' : '' }}">
	...
	?>
                                    ...
                                    {{__('Newsletter signup confirmation')}}
                                ...
                                <div class="formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                                    ...
                                    <a href="{{url('cms/terms-of-use')}}">{{__('Accept Terms & Conditions')}}</a>
                        ...
                        <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('company.register') }}">
                                ...
                                <div class="formrow{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="name" class="form-control" required="required" placeholder="{{__('Full Name')}}" value="{{old('name')}}">
	...
	?>
                                ...
                                <div class="formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                                    ...
                                    <a href="{{url('terms-of-use')}}">{{__('Accept Terms & Conditions')}}</a>
