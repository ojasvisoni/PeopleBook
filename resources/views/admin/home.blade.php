            ...
            <div class="col-md-6 col-sm-6">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                        ...
                        <div class="details">
                            ...
                            <div class="desc"> Todays Opportunities </div>
                        </div>
                    </a> </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                        <div class="visual"> <i class="fa fa-list"></i> </div>
                        <div class="details">
                            ...
                            <div class="desc"> Active Opportunities </div>
                        </div>
                    </a> </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                        ...
                        <div class="details">
                            ...
                            <div class="desc"> Featured Opportunities </div>
                        </div>
                    </a> </div>
            </div>
        </div>
...
<!--                        <div class="scroller-footer">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-share font-dark hide"></i> <span class="caption-subject font-dark bold uppercase">Recent Opportunities</span> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="slimScrol">
                            <ul class="feeds">
...
<!--                        <div class="scroller-footer">
                            <div class="btn-arrow-link pull-right"> <a href="{{ route('list.jobs') }}">See All Opportunities</a> <i class="icon-arrow-right"></i> </div>
                        </div>-->
                    </div>
                </div>
            </div>
...
@else
@include('admin.shared.adhoc_homepage')
@endif
@endsection
@push('scripts')
